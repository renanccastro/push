    ...
    if (options.gcm && options.gcm.apiKey) {
        ...
        self.sendGCM = function(userTokens, notification) {
          ...
          //    restricted_package_name: 'dk.gi2.app'
            ...
            if(typeof notification.contentAvailable !== 'undefined' && notification.contentAvailable){
              messageJson.contentAvailable = true;
            }
            //var message = new gcm.Message();
            var message = new gcm.Message(messageJson);
